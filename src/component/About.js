...
const solecitostext2 = `Estrellitas" betreut neugierige 12 Monate bis 3 Jahre alte Kinder in einer liebevollen Umgebung.Unsere einfühlsamen Betreuer fördern erste Entdeckungen und Geborgenheit.In der "Lunas" Gruppe erleben 25 Kinder im Alter von 3 bis 6 Jahren spannende Abenteuer und kreatives Lernen.Unsere engagierten Pädagogen legen hier den Grundstein für lebenslanges Wachstum und Freundschaften.Jedes Kind wird als einzigartiges Licht geschätzt und von unserem herzlichen Team auf seiner Reise unterstützt.`;

const solecitostext3 = `Damit die Kinder nicht nur “ihre Gruppe” als Lernort nutzen können, gibt es diverse
